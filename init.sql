...
alter table event_mock
    owner to postgres;

create unique index event_mock_unique_key
    on event_mock (key);

INSERT INTO public.event_mock (key, channel, description, is_deleted) VALUES ('stock-created', 'my-mockidoki-topic', 'when stock created', false);
